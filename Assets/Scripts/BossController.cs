...
public class BossController : MonoBehaviour {
    ...
    void Update()
    {
        if (Time.time >= timeToSpawnObelisk)
        {
            ...
            if (whichObeliskToSpawn == 0)
            {
                ...
                timeToSpawnObelisk = Time.time + timeBetweenObeliskSpawn;
                whichObeliskToSpawn++;
            }
            ...
            {
                obeliskInstant = (GameObject)Instantiate(obelisk, new Vector3(35f, 7.6f, -9.91f), obelisk.transform.rotation);
                obeliskInstant.GetComponent<ObeliskController>().setDirection(ObeliskController.Directions.left);
                timeToSpawnObelisk = Time.time + timeBetweenObeliskSpawn;
                whichObeliskToSpawn++;
            }
            else if (whichObeliskToSpawn == 5)
            {
                ...
                timeToSpawnObelisk = Time.time + timeBetweenObeliskSpawn*4;
